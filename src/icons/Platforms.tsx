export function Windows({ size = 60 }) {
  return (
    <svg
      ...
      stroke="#2d74d7"
    >
      <path d="M0 12.402l35.687-4.86.016 34.422-35.67.203zM35.67 45.93l.028 34.453L.028 75.48.026 45.7zm4.326-39.025L87.315 0v41.527l-47.319.376zm47.33 39.349l-.011 41.34-47.319-6.679-.066-34.738z"></path>
    </svg>
  );
}

export function Mac({ size = 60 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 170 170"
